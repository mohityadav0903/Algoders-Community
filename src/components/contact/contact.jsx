              ...
              <p className="fw-light mb-0">
                ...
                <a href="#!">
                  <span
                    ...
                    data-cfemail="4b383e3b3b24393f0b2e332a263b272e65282426"
                  >
                    [email&#160;protected]
                  </span>
                </a>
          ...
          <form>
            <div className="row gx-5 mb-4">
              <div className="col-md-6">
                <label className="text-dark mb-2" for="inputName">
                  Full name
                </label>
                <input
              ...
              <div className="col-md-6">
                <label className="text-dark mb-2" for="inputEmail">
                  Email
                </label>
                <input
                  className="form-control py-4"
            ...
            <div className="mb-4">
              <label className="text-dark mb-2" for="inputMessage">
                Message
              </label>
              <textarea
